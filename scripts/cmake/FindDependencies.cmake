...
if (USE_SNORENOTIFY)
    ...
    if (LibsnoreQt5_FOUND)
        ...
        message(STATUS "Snorenotify version: ${LibsnoreQt5_VERSION}")
    else ()
        message(STATUS "Failed to find snorenotify, using QSystemTrayIcon instead")
    endif()
else()
    message(STATUS "Snorenotify support disabled, using QSystemTrayIcon instead")
endif()
