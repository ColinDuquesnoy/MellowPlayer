...
TEST_CASE("SettingsTests") {
    ...
    SECTION("ConfigSchemaTests") {
        ...
        SECTION("getCategory") {
            ...
            REQUIRE(settings.getCategory("foo") == nullptr);
        }

        SECTION("getSetting") {
            REQUIRE(settings.getSetting("general/confirm-exit") != nullptr);
            REQUIRE(settings.getSetting("notifications/confirm-exit") == nullptr);
        }
    }
    ...
    SECTION("ConfigCategoryTests") {
        ...
        SECTION("getSetting") {
            ...
            REQUIRE(generalCategory->getSetting("foo") == nullptr);
        }
    }
    ...
    SECTION("SettingTests") {
        SECTION("attributes") {
            ...
            setting = settings.getSetting("general/close-to-tray");
            REQUIRE(setting->getKey() == "close-to-tray");
            REQUIRE(setting->getDefaultValue().toBool());
        }
