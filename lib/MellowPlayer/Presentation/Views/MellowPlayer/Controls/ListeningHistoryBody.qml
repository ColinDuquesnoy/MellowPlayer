...
StackLayout {
    ...
    Pane {
        ColumnLayout {
            ...
            Button {
                ...
                highlighted: true
                hoverEnabled: true
                onClicked: settings.get(SettingKey.PRIVACY_ENABLE_LISTENING_HISTORY).value = true
    ...
    QtObject {
        ...
        property var historyEnabledSetting: settings.get(SettingKey.PRIVACY_ENABLE_LISTENING_HISTORY)
    }
}
