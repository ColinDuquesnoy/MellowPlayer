function translateName(name) {
    var translations = {
        ...
        'Display a notification at startup when a new version of MellowPlayer is available,': qsTr('Display a notification at startup when a new version of MellowPlayer is available,'),
...
function translateToolTip(toolTip) {
    var translations = {
        ...
        'Enabled/Disable displaying a notification when a new version of MellowPlayer is available': qsTr('Enabled/Disable displaying a notification when a new version of MellowPlayer is available'),
