...
{
    return QIcon::fromTheme("media-playback-start", QIcon("://MellowPlayer/Presentation/Resources/icons/"
...
{
    return QIcon::fromTheme("media-seek-forward", QIcon("://MellowPlayer/Presentation/Resources/icons/"
                                                        "media-seek-forward.png"));
}

QIcon IconProvider::previous()
{
    return QIcon::fromTheme("media-seek-backward", QIcon("://MellowPlayer/Presentation/Resources/icons/"
